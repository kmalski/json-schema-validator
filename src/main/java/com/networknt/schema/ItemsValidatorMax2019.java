...
public class ItemsValidatorMax2019 extends BaseJsonValidator implements JsonValidator {
    private static final Logger logger = LoggerFactory.getLogger(ItemsValidatorMax2019.class);
    ...
    public ItemsValidatorMax2019(String schemaPath, JsonNode schemaNode, JsonSchema parentSchema,
        ...
        if (isMaxV201909) {
            ...
            foundSchema = schemaNode.isObject()
                    ? new JsonSchema(validationContext, schemaPath, parentSchema.getCurrentUri(), schemaNode, parentSchema)
                    : null;
